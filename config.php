...
define('DB_NAME', 'gamersre_tienda');    // <-- Nombre de la BD en cPanel
define('DB_USER', 'gamersre_admin');     // <-- Usuario de BD en cPanel
define('DB_PASS', 'TU_PASSWORD_AQUI');  // <-- Password de BD en cPanel
